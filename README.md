...
1. **Tracking de horas desde Jira Cloud/CDS**: detecta entradas y salidas de estados `DOING`, calcula horas hábiles y persiste logs mensuales en JSON.
   - Dominio actual del tracker CDS: `https://nbch.atlassian.net/`.
...
- acceso a Jira Cloud/CDS: `loghoras/infrastructure/jira_client.py`
